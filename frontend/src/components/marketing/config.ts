...
export const PRODUCT = {
  ...
  heroHeadline: "A double-entry ledger for your own money.",
  heroSub:
    "Every account you own in one ledger, with a dashboard over it: net worth, where the money went, and anything that needs sorting. New Zealand bank accounts sync through Akahu; anything a bank feed can't see, you enter yourself.",
